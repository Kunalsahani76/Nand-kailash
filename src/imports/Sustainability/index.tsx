...
function Frame7({ onNavigateAbout, onNavigateHome, onNavigateProjects, onNavigateSustainability }: SustainabilityProps) {
  return (
...
export default function Sustainability({ onNavigateAbout, onNavigateHome, onNavigateProjects, onNavigateSustainability }: SustainabilityProps) {
  return (
