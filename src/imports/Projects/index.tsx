...
function Frame7({ onNavigateAbout, onNavigateHome, onNavigateProjects, onNavigateSustainability }: ProjectsProps) {
  return (
...
export default function Projects({ onNavigateAbout, onNavigateHome, onNavigateProjects, onNavigateSustainability }: ProjectsProps) {
  return (
