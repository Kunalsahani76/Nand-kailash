...
import  from "./4923fd2217cd78454b6ae5cce39f49c55f5ca1af.png";
import  from "./852d1a0e7fba9c9440ebf82fe084cb245204e492.png";
import  from "./840f076aa1843c0ad6346cfd59fc69fc6bdcf34e.png";
import  from "./5c6064db9c93ed8edf3a338ab14fa795564bda92.png";
import imgDgpsIcon from "./0315a6d751bcb88be1f65e7ae6f1c4b7bedb8d38.png";
import imgTotalStationIcon from "./8f20ecd4af6b1b01887883e1e278be30879fd1ab.png";
import imgDigitexLocatorIcon from "./ce9292637cc432a59a36329828af5059f0bfd5f5.png";
import imgDigitalLevelIcon from "./0d0af175fbb1b7afe3856bed075ea496e01b0549.png";
import imgAutoLevelIcon from "./e348eb22c96e0d6aabb81a8af718fadf88242a2d.png";
import imgGpsIcon from "./637e0d148af5cdac36a9545a8ee24aec9e4c9a69.png";
import imgSoftwareIcon from "./a90d0809cdbf3fea98a3e3d33716d39b27f83e24.png";
import imgCadIcon from "./d02fdc53d9fef34ef9c2b5456861eda9a22c0ce8.png";
import imgHpPlotterIcon from "./75fa3b6167771fde4d23bfb6773c9fa8f7bcc233.png";
  ...
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full">
      ...
      <div className="[word-break:break-word] capitalize font-['Sora:ExtraBold',sans-serif] font-extrabold leading-[0] min-w-full relative shrink-0 text-[0px] text-white tracking-[-1.28px] w-[min-content]">
        <p className="leading-[1.1] mb-0 text-[64px]">Precision Surveys Reliable Data.</p>
        <p className="leading-[1.1] text-[#355d9b] text-[64px]">Stronger Infrastructure.</p>
      </div>
    </div>
  );
}
...
function Frame48() {
  return (
    <div className="content-stretch flex flex-col gap-[18px] items-start relative shrink-0 w-[1162px]">
      <Frame47 />
      <p className="[word-break:break-word] capitalize font-['Inter:Regular',sans-serif] font-normal leading-[32px] not-italic relative shrink-0 text-[18px] text-[rgba(255,255,255,0.75)] w-[429px]">{`Advanced land surveying solutions using DGPS, Total Station, Drone & GIS technology for accurate mapping and better projectoutcomes across India.`}</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[10px] text-white uppercase whitespace-nowrap">
        <p className="leading-[15px]">DGPS SETS</p>
      </div>
    </div>
  );
}
...
function Container5() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#d1d5db] text-[10px] whitespace-nowrap">
        <p className="leading-[15px]">High precision survey equipment</p>
      </div>
    </div>
  );
}
...
function Container2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[155.61px]" data-name="Container">
      <Container3 />
      <Container4 />
      <Container5 />
    </div>
...
function Container9() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[10px] text-white uppercase whitespace-nowrap">
        <p className="leading-[15px]">TOTAL STATIONS</p>
      </div>
    </div>
  );
}
...
function Container10() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#d1d5db] text-[10px] whitespace-nowrap">
        <p className="leading-[15px]">Leica instruments for accurate data</p>
      </div>
    </div>
  );
}
...
function Container7() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[167.28px]" data-name="Container">
      <Container8 />
      <Container9 />
      <Container10 />
    </div>
...
function Container14() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[10px] text-white uppercase whitespace-nowrap">
        <p className="leading-[15px]">PROJECTS COMPLETED</p>
      </div>
    </div>
  );
}
...
function Container15() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#d1d5db] text-[10px] whitespace-nowrap">
        <p className="leading-[15px]">Delivered across India successfully</p>
      </div>
    </div>
  );
}
...
function Container12() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[166.5px]" data-name="Container">
      <Container13 />
      <Container14 />
      <Container15 />
    </div>
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[10px] text-white whitespace-nowrap">
        <p className="leading-[15px]">Serving clients in all major states</p>
      </div>
    </div>
  );
}
...
function Frame50() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[38px] items-start left-[40px] top-[102px] w-[1114px]">
      <Frame49 />
      <Frame46 />
    </div>
  );
  ...
  return (
    <div className="h-[749px] overflow-clip relative shrink-0 w-[1440px]">
      <div aria-hidden className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bg-gradient-to-r from-[rgba(0,0,0,0.8)] inset-0 to-[167.85%] to-[rgba(102,102,102,0)]" />
      </div>
      <Frame50 />
    </div>
  );
  ...
  return (
    <div className="bg-[rgba(55,95,157,0.6)] content-stretch flex items-start px-[12px] py-[8px] relative rounded-[2px] shrink-0" data-name="Overlay">
      <div className="[word-break:break-word] capitalize flex flex-col font-['Inter:Regular',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-white tracking-[0.96px] whitespace-nowrap">
        <p className="leading-[normal]">ENGINEERING PRECISION</p>
      </div>
    </div>
  );
}
...
function Heading() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[464px]" data-name="Heading 2">
      <div className="[word-break:break-word] capitalize flex flex-col font-['Sora:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#111827] text-[48px] w-full">
        <p className="leading-[60px] mb-0">Professional Land</p>
        <p className="leading-[60px]">Surveying Services</p>
      </div>
    </div>
  );
}
    ...
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full" data-name="Item">
      <div className="relative shrink-0 size-[20px]" data-name="Icon">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
          <path d={svgPaths.p1caa9380} fill="var(--fill-0, #375F9D)" id="Icon" />
        </svg>
      </div>
      <div className="[word-break:break-word] capitalize flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#4b5563] text-[20px] whitespace-nowrap">
        <p className="leading-[34px]">Sub-centimeter accuracy for critical engineering projects</p>
      </div>
    </div>
  );
}
...
function Item1() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full" data-name="Item">
      ...
      <div className="[word-break:break-word] capitalize flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#4b5563] text-[20px] whitespace-nowrap">
        <p className="leading-[34px]">Comprehensive GIS-ready data deliverables</p>
      </div>
    </div>
  );
}
...
function Item2() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full" data-name="Item">
      ...
      <div className="[word-break:break-word] capitalize flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#4b5563] text-[20px] whitespace-nowrap">
        <p className="leading-[34px]">Expert navigation of regulatory and legal land requirements</p>
      </div>
    </div>
  );
}
...
function Item3() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full" data-name="Item">
      ...
      <div className="[word-break:break-word] capitalize flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#4b5563] text-[20px] whitespace-nowrap">
        <p className="leading-[34px]">Fast turnaround with dedicated project management</p>
      </div>
    </div>
  );
}
...
function List() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-[625px]" data-name="List">
      <Item />
      <Item1 />
      <Item2 />
      <Item3 />
...
function Frame29() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] h-[546px] items-start py-[20px] relative shrink-0">
      <Overlay1 />
      <Heading />
      <Container21 />
    </div>
  ...
  return (
    <div className="relative shrink-0 w-full">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-between px-[80px] py-[30px] relative size-full">
          <Frame29 />
  ...
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="Heading 2">
      <div className="[word-break:break-word] capitalize flex flex-col font-['Sora:Regular',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#ffce1b] text-[36px] text-center w-[840px]">
        <p className="leading-[normal]">Industries We Serve</p>
      </div>
    </div>
  );
}
    ...
    <div className="absolute left-0 size-[45.008px] top-0" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 45.0079 45.0079">
        <g id="Container">
          ...
          <path d={svgPaths.p38487100} fill="var(--fill-0, white)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Frame12() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[12px] h-full items-start not-italic relative shrink-0 w-[341.903px]">
      <p className="font-['Poppins:Bold',sans-serif] leading-[29.717px] relative shrink-0 text-[20px] text-white w-full">Topographic Surveys</p>
      <div className="font-['Inter:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[18px] text-[rgba(255,255,255,0.55)] w-full whitespace-pre-wrap">
        <p className="leading-[27.736px] mb-0">{`Industrial Sites, Power Projects `}</p>
        <p className="leading-[27.736px]">{`& AreaDevelopment`}</p>
      </div>
    </div>
  );
}
...
function Container26() {
  return (
    <div className="h-[20.875px] relative shrink-0 w-[25px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 25 20.875">
        <g id="Container">
          <path d={svgPaths.p8fec700} fill="var(--fill-0, white)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Frame18() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[12px] h-full items-start not-italic relative shrink-0 w-[341.903px]">
      <p className="font-['Poppins:Bold',sans-serif] leading-[29.717px] relative shrink-0 text-[20px] text-white w-full">Hydrographic Surveys</p>
      <div className="font-['Inter:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[18px] text-[rgba(255,255,255,0.55)] w-full">
        <p className="leading-[27.736px] mb-0">{`Waterways, Reservoirs &`}</p>
        <p className="leading-[27.736px]">Irrigation Systems</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="absolute left-0 size-[45.008px] top-0" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 45.0079 45.0079">
        <g id="Container">
          <path d={svgPaths.p14ae9940} fill="var(--fill-0, #375F9D)" />
          <path d={svgPaths.p321a6d00} fill="var(--fill-0, white)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Frame21() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[12px] h-full items-start not-italic relative shrink-0 w-[341.903px]">
      <p className="font-['Poppins:Bold',sans-serif] leading-[29.717px] relative shrink-0 text-[20px] text-white w-full">Transportation</p>
      <div className="font-['Inter:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[18px] text-[rgba(255,255,255,0.55)] w-full">
        <p className="leading-[27.736px] mb-0">{`Highway, Railway, Airport &`}</p>
        <p className="leading-[27.736px]">Ropeway</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="absolute left-0 size-[45.008px] top-0" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 45.0079 45.0079">
        <g id="Container">
          <path d={svgPaths.p14ae9940} fill="var(--fill-0, #375F9D)" />
          <path d={svgPaths.p2e253600} fill="var(--fill-0, white)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Frame24() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[12px] h-full items-start not-italic relative shrink-0 w-[341.903px]">
      <p className="font-['Poppins:Bold',sans-serif] leading-[29.717px] min-w-full relative shrink-0 text-[20px] text-white w-[min-content]">Pipeline Route Surveys</p>
      <div className="font-['Inter:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[18px] text-[rgba(255,255,255,0.55)] w-[351px]">
        <p className="leading-[27.736px] mb-0">{`Crude Oil & Product`}</p>
        <p className="leading-[27.736px]">Pipelines</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="absolute left-0 size-[45.008px] top-0" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 45.0079 45.0079">
        <g id="Container">
          <path d={svgPaths.p14ae9940} fill="var(--fill-0, #375F9D)" />
          <path d={svgPaths.p27295f00} fill="var(--fill-0, white)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Frame26() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[12px] h-full items-start not-italic relative shrink-0 w-[341.903px]">
      <p className="font-['Poppins:Bold',sans-serif] leading-[29.717px] relative shrink-0 text-[20px] text-white w-full">Power Project Surveys</p>
      <div className="font-['Inter:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[18px] text-[rgba(255,255,255,0.55)] w-full">
        <p className="leading-[27.736px] mb-0">{`Thermal, Hydel, Nuclear &`}</p>
        <p className="leading-[27.736px]">Renewable</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="absolute left-0 size-[45.008px] top-0" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 45.0079 45.0079">
        <g id="Container">
          <path d={svgPaths.p14ae9940} fill="var(--fill-0, #375F9D)" />
          <path d={svgPaths.p30de7880} fill="var(--fill-0, white)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Frame28() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[12px] h-full items-start not-italic relative shrink-0 w-[341.903px]">
      <p className="font-['Poppins:Bold',sans-serif] leading-[29.717px] relative shrink-0 text-[20px] text-white w-full">OLS Surveys</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27.736px] relative shrink-0 text-[18px] text-[rgba(255,255,255,0.55)] w-full">{`Airports & Heliports`}</p>
    </div>
  );
}
...
function Heading2() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="Heading 2">
      <div className="[word-break:break-word] capitalize flex flex-col font-['Sora:Regular',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#ffce1b] text-[36px] text-center w-[840px]">
        <p className="leading-[normal]">Infrastructure Gallery</p>
      </div>
    </div>
  );
}
...
function () {
  return (
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="AB6AXuAUPM9bg4_aBmUxr1HxGWs644Q_XrbJ2ETaap3a150xiwllAP-S-MzgIkcQgw11Ck9I3ej-i74YOyGGqos42yJdQJskdrplImANsWBdzowI1W9v4dsV1KjmVd5jYKCIVf8ur3iKjDItpSE3q2Cv_jITjObtXdWroK2EaCpMqNnDCha-D4d5Z7bl2GRLQ3mdQd3RDYhXKLtsjk3N-RG-ks0m3jLxgv6uiqv1vI2qNvSSnyqICIOO6gpDKoBjhNmCvSJkXZpek6gb7nc">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-[109.63%] left-0 max-w-none top-[-4.82%] w-full" src={} />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[256px] relative shrink-0 w-full z-[2]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start justify-center overflow-clip relative rounded-[inherit] size-full">
        < />
      </div>
    </div>
  );
}
...
function Heading3() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 3">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#e5e2e1] text-[24px] w-full">
        <p className="leading-[32px]">Irrigation Projects</p>
      </div>
    </div>
  );
}
...
function Container34() {
  return (
    <div className="content-stretch flex flex-col items-start pb-[15.5px] pt-[3.5px] relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#bacac4] text-[16px] w-full">
        <p className="leading-[26px]">Command Area Development</p>
      </div>
    </div>
  );
}
...
function Container35() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#e5e2e1] text-[14px] text-center tracking-[0.7px] whitespace-nowrap">
        <p className="leading-[20px]">View Project Details</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Container">
          <path d={svgPaths.p1a406200} fill="var(--fill-0, #E5E2E1)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Button() {
  return (
    <div className="bg-[#2a2a2a] relative rounded-[4px] shrink-0 w-full" data-name="Button">
...
function Container33() {
  return (
    <div className="relative shrink-0 w-full z-[1]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[8.5px] items-start p-[24px] relative size-full">
        <Heading3 />
        <Container34 />
        <Button />
      </div>
...
function ProjectCard1Irrigation() {
  return (
    <div className="bg-[#1c1b1b] h-[470px] relative rounded-[8px] shrink-0 w-[266px]" data-name="Project Card 1: Irrigation">
      <div className="content-stretch flex flex-col isolate items-start overflow-clip p-px relative rounded-[inherit] size-full">
        <Container32 />
        <Container33 />
      </div>
      <div aria-hidden className="absolute border border-[#3b4a45] border-solid inset-0 pointer-events-none rounded-[8px] shadow-[15px_262px_74px_0px_rgba(55,95,157,0),10px_168px_67px_0px_rgba(55,95,157,0.01),5px_94px_57px_0px_rgba(55,95,157,0.05),2px_42px_42px_0px_rgba(55,95,157,0.09),1px_10px_23px_0px_rgba(55,95,157,0.1)]" />
    </div>
  );
}

function () {
  return (
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="AB6AXuAI-kyflUHgI9_2G3O7ggS5rcv1NeX_htYo4Wm0QOcEvTY88tmh4htOFX30Cb8ueo6dc7yk4OkfxhGrR405rMLLug3-x3m4U7AjQYmnnZgaW29sfErtfkKrJqDjrG79ribKhhdh5WQ1C-XcNFh__WGRfRFxY_NZ9sLZxFmnU0Mixf-3a5uu-YxOEPrW6ejw1likzdK1-hxelhPaOUrg8TMaD0wSyL2Vl9ZrqGkeaiNpQOkUdjMQI1VQwnMBU6FPTPT3CeJsVlepDyI">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-[109.64%] left-0 max-w-none top-[-4.82%] w-full" src={} />
      </div>
    </div>
  );
}
...
function Container37() {
  return (
    <div className="h-[256px] relative shrink-0 w-full z-[2]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start justify-center overflow-clip relative rounded-[inherit] size-full">
        < />
      </div>
    </div>
  );
}
...
function Heading4() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 3">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#e5e2e1] text-[24px] w-full">
        <p className="leading-[32px]">Power Projects</p>
      </div>
    </div>
  );
}
...
function Container39() {
  return (
    <div className="content-stretch flex flex-col items-start pb-[15.5px] pt-[3.5px] relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#bacac4] text-[16px] w-full">
        <p className="leading-[26px] mb-0">Thermal, Hydel, Nuclear,</p>
        <p className="leading-[26px]">Non-conventional</p>
      </div>
    </div>
  );
}
...
function ProjectCard2Power() {
  return (
    <div className="bg-[#1c1b1b] h-[470px] relative rounded-[8px] shrink-0 w-[266px]" data-name="Project Card 2: Power">
      <div className="content-stretch flex flex-col isolate items-start overflow-clip pb-[7px] pt-px px-px relative rounded-[inherit] size-full">
        <Container37 />
        <Container38 />
      </div>
      <div aria-hidden className="absolute border border-[#3b4a45] border-solid inset-0 pointer-events-none rounded-[8px] shadow-[0px_143px_40px_0px_rgba(55,95,157,0),0px_92px_37px_0px_rgba(55,95,157,0.02),0px_52px_31px_0px_rgba(55,95,157,0.06),0px_23px_23px_0px_rgba(55,95,157,0.11),0px_6px_13px_0px_rgba(55,95,157,0.12)]" />
    </div>
  );
}

function () {
  return (
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="AB6AXuD83jHJxyeZO_TQKXL06MV2F3JUMrSEtQCXieJFDxzDdC8uA26L3wYrnIricu7aN0u9fxo6Dm9AcelQTyRkmdbNOTxRbGbnAsPjbClXljQva1RwMMtDBBkkdrvZCrzEkecUGiCnBJdmAWs5QcEjZ-t-70webWZa7KhQvnNxoSvzpueGrxoK0Vs1yTawsqx3ylyj7xlw-sA32puff79ZuWV8OE58pIIKWyWHm5LDxJ0fMfUQIJB2D2q1ZQleqm-0WARWmLvkgrVvMaA">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-[109.63%] left-0 max-w-none top-[-4.82%] w-full" src={} />
      </div>
    </div>
  );
}
...
function Container42() {
  return (
    <div className="h-[256px] relative shrink-0 w-full z-[2]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start justify-center overflow-clip relative rounded-[inherit] size-full">
        < />
      </div>
    </div>
  );
}
...
function Heading5() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 3">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#e5e2e1] text-[24px] w-full">
        <p className="leading-[32px]">Transportation</p>
      </div>
    </div>
  );
}
...
function Container44() {
  return (
    <div className="content-stretch flex flex-col items-start pb-[15.5px] pt-[3.5px] relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#bacac4] text-[16px] w-full">
        <p className="leading-[26px]">Highway, Railway, Airport, Ropeway</p>
      </div>
    </div>
  );
}
...
function ProjectCard3Transportation() {
  return (
    <div className="bg-[#1c1b1b] h-[470px] relative rounded-[8px] shrink-0 w-[266px]" data-name="Project Card 3: Transportation">
      <div className="content-stretch flex flex-col isolate items-start overflow-clip pb-[7px] pt-px px-px relative rounded-[inherit] size-full">
        <Container42 />
        <Container43 />
      </div>
...
function () {
  return (
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="AB6AXuCYOI1KddVcd4sirCopIMGpVPuUXvYU28wAVSEL3-O_w0jKr4bduaU-lue-w0-BEfWr7SjSXZT0gS_TrAQkQSej0zTWIw-fhhkZeRdLeBCTs59aKYWj8EVanrdwoXEUutgE5acptLrmCZGDHDPrzQqENh3mi4RRd23Yoml62fLFkxZvTVD6SJcGli79-Fy6C0ALVoYTeTW9xSWLNcptxMLyXTxN9vyOU-VJPLP0utuLaoFGX8Ol128QnNAEbXlD9oByPOA3OLNFQdY">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-[109.63%] left-0 max-w-none top-[-4.82%] w-full" src={} />
      </div>
    </div>
  );
}
...
function Container47() {
  return (
    <div className="h-[256px] relative shrink-0 w-full z-[2]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start justify-center overflow-clip relative rounded-[inherit] size-full">
        < />
      </div>
    </div>
  );
}
...
function Heading6() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 3">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#e5e2e1] text-[24px] w-full">
        <p className="leading-[32px]">Petroleum</p>
      </div>
    </div>
  );
}
...
function Container49() {
  return (
    <div className="content-stretch flex flex-col items-start pb-[15.5px] pt-[3.5px] relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#bacac4] text-[16px] w-full">
        <p className="leading-[26px]">Refineries, Product and Crude Pipelines</p>
      </div>
    </div>
  );
}
...
function ProjectCard4Petroleum() {
  return (
    <div className="bg-[#1c1b1b] h-[470px] relative rounded-[8px] shrink-0 w-[266px]" data-name="Project Card 4: Petroleum">
      <div className="content-stretch flex flex-col isolate items-start overflow-clip p-px relative rounded-[inherit] size-full">
        <Container47 />
        <Container48 />
      </div>
...
function () {
  return (
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="AB6AXuAkoHZQ7t5kCojZuc7zFYZve3Inyu4QWxOLlctKMpL5wuqmdTemooBbt19Edt2WtciSX13tNw_FnHycEqWqxzWPSa_AL68yWhFyn1zOwXIOY49S9fX0iyLXHzyFZPKYaKxhNyoY5BIeT94ZgXUb6bjHsV4gXqb8c1M-nImJ2X4dqBuCfQGtg3e3kUD1CdrxZ4P7e1FajnDTc6K7B7h8rx0WKDWHQOwt_AwbWN2Z4I5f5jme-wkAbWdhAcy9EFglK4XAwN_00anx2cI">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-[109.64%] left-0 max-w-none top-[-4.82%] w-full" src={} />
      </div>
    </div>
  );
}
...
function Container52() {
  return (
    <div className="h-[256px] relative shrink-0 w-full z-[2]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start justify-center overflow-clip relative rounded-[inherit] size-full">
        < />
      </div>
    </div>
  );
}
...
function Heading7() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 3">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#e5e2e1] text-[24px] w-full">
        <p className="leading-[32px]">Housing</p>
      </div>
    </div>
  );
}
...
function Container54() {
  return (
    <div className="content-stretch flex flex-col items-start pb-[15.5px] pt-[3.5px] relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#bacac4] text-[16px] w-full">
        <p className="leading-[26px]">Commercial area development</p>
      </div>
    </div>
  );
}
...
function ProjectCard5Housing() {
  return (
    <div className="bg-[#1c1b1b] h-[470px] relative rounded-[8px] shrink-0 w-[266px]" data-name="Project Card 5: Housing">
      <div className="content-stretch flex flex-col isolate items-start overflow-clip pb-[53px] pt-px px-px relative rounded-[inherit] size-full">
        <Container52 />
        <Container53 />
      </div>
      <div aria-hidden className="absolute border border-[#3b4a45] border-solid inset-0 pointer-events-none rounded-[8px] shadow-[0px_143px_40px_0px_rgba(55,95,157,0),0px_92px_37px_0px_rgba(55,95,157,0.02),0px_52px_31px_0px_rgba(55,95,157,0.06),0px_23px_23px_0px_rgba(55,95,157,0.11),0px_6px_13px_0px_rgba(55,95,157,0.12)]" />
...
function Frame43() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0">
      <ProjectCard1Irrigation />
      <ProjectCard2Power />
      <ProjectCard3Transportation />
      <ProjectCard4Petroleum />
      <ProjectCard5Housing />
    </div>
  );
}
...
function Frame44() {
  return (
    <div className="bg-[#212121] content-stretch flex flex-col gap-[55px] items-center py-[80px] relative shrink-0 w-full">
      <Container31 />
      <Frame43 />
    </div>
  );
  ...
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="Heading 2">
      <div className="[word-break:break-word] capitalize flex flex-col font-['Sora:Regular',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#ffce1b] text-[36px] text-center whitespace-nowrap">
        <p className="leading-[normal]">{`OUR ADVANCED, CALIBRATED EQUIPMENT & SOFTWERE`}</p>
      </div>
    </div>
  );
}
...
function DgpsIcon() {
  return (
    <div className="flex-[1_0_0] h-full min-w-px relative rounded-[4px]" data-name="DGPS Icon">
      <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[4px]">
        <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgDgpsIcon} />
      </div>
    </div>
  );
}
...
function Heading9() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 3">
      <div className="[word-break:break-word] flex flex-col font-['Nimbus_Sans:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#375f9d] text-[18px] w-full">
        <p className="leading-[22.5px]">DGPS</p>
      </div>
    </div>
  );
}
...
function Container60() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Nimbus_Sans:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[14px] text-white w-full">
        <p className="leading-[20px]">(13 Sets)</p>
      </div>
    </div>
  );
}
...
function Background4() {
  return (
    <div className="absolute bg-[#375f9d] right-[13px] rounded-[4px] top-[13px]" data-name="Background">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start px-[8px] py-[2px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Nimbus_Sans:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[10px] text-white tracking-[0.5px] whitespace-nowrap">
          <p className="leading-[15px]">QUANTITY: 13</p>
        </div>
      </div>
    </div>
  );
...
function Card1Dgps() {
  return (
    <div className="bg-gradient-to-b content-stretch flex from-[rgba(255,255,255,0.1)] gap-[14px] h-[100px] items-center justify-center min-h-[100px] overflow-clip px-[10px] py-[20px] relative rounded-[10.386px] shrink-0 to-[rgba(153,153,153,0.1)] w-[368px]" data-name="Card 1: DGPS">
      <Margin1 />
      <Container59 />
      <Background4 />
    </div>
...
function TotalStationIcon() {
  return (
    <div className="flex-[1_0_0] h-full min-w-px relative rounded-[4px]" data-name="Total Station Icon">
      <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[4px]">
        <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgTotalStationIcon} />
      </div>
    </div>
  );
}
...
function Heading10() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 3">
      <div className="[word-break:break-word] flex flex-col font-['Nimbus_Sans:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#375f9d] text-[18px] w-full">
        <p className="leading-[22.5px]">Total Station</p>
      </div>
    </div>
  );
}
...
function Background5() {
  return (
    <div className="absolute bg-[#375f9d] right-[13px] rounded-[4px] top-[13px]" data-name="Background">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start px-[8px] py-[2px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Nimbus_Sans:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[10px] text-white tracking-[0.5px] whitespace-nowrap">
          <p className="leading-[15px]">QUANTITY: 9</p>
        </div>
      </div>
    </div>
  );
...
function Card2TotalStation() {
  return (
    <div className="bg-gradient-to-b content-stretch flex from-[rgba(255,255,255,0.1)] gap-[14px] h-[100px] items-center justify-center min-h-[100px] overflow-clip px-[10px] py-[20px] relative rounded-[10.386px] shrink-0 to-[rgba(153,153,153,0.1)] w-[368px]" data-name="Card 2: Total Station">
      <Margin2 />
      <Container62 />
      <Background5 />
    </div>
...
function DigitexLocatorIcon() {
  return (
    <div className="flex-[1_0_0] h-full min-w-px relative rounded-[4px]" data-name="Digitex Locator Icon">
      <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[4px]">
        <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgDigitexLocatorIcon} />
      </div>
    </div>
  );
}
...
function Heading11() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 3">
      <div className="[word-break:break-word] flex flex-col font-['Nimbus_Sans:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#375f9d] text-[18px] w-full">
        <p className="leading-[22.5px]">Digitex Locator</p>
      </div>
    </div>
  );
}
...
function Background6() {
  return (
    <div className="absolute bg-[#375f9d] right-[13px] rounded-[4px] top-[13px]" data-name="Background">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start px-[8px] py-[2px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Nimbus_Sans:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[10px] text-white tracking-[0.5px] whitespace-nowrap">
          <p className="leading-[15px]">QUANTITY: 2</p>
        </div>
      </div>
    </div>
  );
...
function Card3DigitexLocator() {
  return (
    <div className="bg-gradient-to-b content-stretch flex from-[rgba(255,255,255,0.1)] gap-[14px] h-[100px] items-center justify-center min-h-[100px] overflow-clip px-[10px] py-[20px] relative rounded-[10.386px] shrink-0 to-[rgba(153,153,153,0.1)] w-[368px]" data-name="Card 3: Digitex Locator">
      <Margin3 />
      <Container65 />
      <Background6 />
    </div>
...
function DigitalLevelIcon() {
  return (
    <div className="flex-[1_0_0] h-full min-w-px relative rounded-[4px]" data-name="Digital Level Icon">
      <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[4px]">
        <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgDigitalLevelIcon} />
      </div>
    </div>
  );
}
...
function Heading12() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 3">
      <div className="[word-break:break-word] flex flex-col font-['Nimbus_Sans:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#375f9d] text-[18px] w-full">
        <p className="leading-[22.5px]">Digital Level</p>
      </div>
    </div>
  );
}
...
function Card4DigitalLevel() {
  return (
    <div className="bg-gradient-to-b content-stretch flex from-[rgba(255,255,255,0.1)] gap-[14px] h-[100px] items-center justify-center min-h-[100px] overflow-clip px-[10px] py-[20px] relative rounded-[10.386px] shrink-0 to-[rgba(153,153,153,0.1)] w-[368px]" data-name="Card 4: Digital Level">
      <Margin4 />
      <Container67 />
      <Background7 />
    </div>
...
function AutoLevelIcon() {
  return (
    <div className="flex-[1_0_0] h-full min-w-px relative rounded-[4px]" data-name="Auto Level Icon">
      <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[4px]">
        <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgAutoLevelIcon} />
      </div>
    </div>
  );
}
...
function Heading13() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 3">
      <div className="[word-break:break-word] flex flex-col font-['Nimbus_Sans:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#375f9d] text-[18px] w-full">
        <p className="leading-[22.5px]">Auto Level</p>
      </div>
    </div>
  );
}
...
function Card5AutoLevel() {
  return (
    <div className="bg-gradient-to-b content-stretch flex from-[rgba(255,255,255,0.1)] gap-[14px] h-[100px] items-center justify-center min-h-[100px] overflow-clip px-[10px] py-[20px] relative rounded-[10.386px] shrink-0 to-[rgba(153,153,153,0.1)] w-[368px]" data-name="Card 5: Auto Level">
      <Margin5 />
      <Container70 />
      <Background8 />
    </div>
...
function GpsIcon() {
  return (
    <div className="flex-[1_0_0] h-full min-w-px relative rounded-[4px]" data-name="GPS Icon">
      <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[4px]">
        <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgGpsIcon} />
      </div>
    </div>
  );
}
...
function Heading14() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 3">
      <div className="[word-break:break-word] flex flex-col font-['Nimbus_Sans:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#375f9d] text-[18px] w-full">
        <p className="leading-[22.5px]">GPS</p>
      </div>
    </div>
  );
}
...
function Card6Gps() {
  return (
    <div className="bg-gradient-to-b content-stretch flex from-[rgba(255,255,255,0.1)] gap-[14px] h-[100px] items-center justify-center min-h-[100px] overflow-clip px-[10px] py-[20px] relative rounded-[10.386px] shrink-0 to-[rgba(153,153,153,0.1)] w-[368px]" data-name="Card 6: GPS">
      <Margin6 />
      <Container73 />
      <Background9 />
    </div>
...
function SoftwareIcon() {
  return (
    <div className="flex-[1_0_0] h-full min-w-px relative rounded-[4px]" data-name="Software Icon">
      <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[4px]">
        <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgSoftwareIcon} />
      </div>
    </div>
  );
}
...
function Heading15() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 3">
      <div className="[word-break:break-word] flex flex-col font-['Nimbus_Sans:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#375f9d] text-[18px] w-full">
        <p className="leading-[22.5px]">Data processing Software</p>
      </div>
    </div>
  );
}
...
function Card7DataProcessingSoftware() {
  return (
    <div className="bg-gradient-to-b content-stretch flex from-[rgba(255,255,255,0.1)] gap-[14px] h-[100px] items-center justify-center min-h-[100px] overflow-clip px-[10px] py-[20px] relative rounded-[10.386px] shrink-0 to-[rgba(153,153,153,0.1)] w-[368px]" data-name="Card 7: Data processing Software">
      <Margin7 />
      <Container75 />
      <Background10 />
    </div>
...
function CadIcon() {
  return (
    <div className="flex-[1_0_0] h-full min-w-px relative rounded-[4px]" data-name="CAD Icon">
      <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[4px]">
        <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgCadIcon} />
      </div>
    </div>
  );
}
...
function Heading16() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 3">
      <div className="[word-break:break-word] flex flex-col font-['Nimbus_Sans:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#375f9d] text-[18px] w-full">
        <p className="leading-[22.5px]">CAD Software</p>
      </div>
    </div>
  );
}
...
function Card8CadSoftware() {
  return (
    <div className="bg-gradient-to-b content-stretch flex from-[rgba(255,255,255,0.1)] gap-[14px] h-[100px] items-center justify-center min-h-[100px] overflow-clip px-[10px] py-[20px] relative rounded-[10.386px] shrink-0 to-[rgba(153,153,153,0.1)] w-[368px]" data-name="Card 8: CAD Software">
      <Margin8 />
      <Container77 />
      <Background11 />
    </div>
...
function HpPlotterIcon() {
  return (
    <div className="flex-[1_0_0] h-full min-w-px relative rounded-[4px]" data-name="HP Plotter Icon">
      <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[4px]">
        <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgHpPlotterIcon} />
      </div>
    </div>
  );
}
...
function Heading17() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 3">
      <div className="[word-break:break-word] flex flex-col font-['Nimbus_Sans:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#375f9d] text-[18px] w-full">
        <p className="leading-[22.5px]">HP Plotter</p>
      </div>
    </div>
  );
}
...
function Background12() {
  return (
    <div className="absolute bg-[#375f9d] right-[13px] rounded-[4px] top-[13px]" data-name="Background">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start px-[8px] py-[2px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Nimbus_Sans:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[10px] text-white tracking-[0.5px] whitespace-nowrap">
          <p className="leading-[15px]">QUANTITY: 1</p>
        </div>
      </div>
    </div>
  );
...
function Card9HpPlotter() {
  return (
    <div className="bg-gradient-to-b content-stretch flex from-[rgba(255,255,255,0.1)] gap-[14px] h-[100px] items-center justify-center min-h-[100px] overflow-clip px-[10px] py-[20px] relative rounded-[10.386px] shrink-0 to-[rgba(153,153,153,0.1)] w-[368px]" data-name="Card 9: HP Plotter">
      <Margin9 />
      <Container79 />
      <Background12 />
    </div>
...
function Frame41() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-[1152px]">
      <Frame38 />
      <Frame39 />
      <Frame40 />
    </div>
...
function Icon3() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_1_821)" id="Icon">
...
function Frame7({ onNavigateAbout, onNavigateHome, onNavigateLandSurveying, onNavigateSolarWind, onNavigateBuildingConstruction, onNavigateElectricWork, onNavigateBuildingManagement, onNavigateProjects, onNavigateSustainability, onNavigateCareers, onNavigateContact }: ServiceSuryeysProps) {
  return (
...
export default function ServiceSuryeys({ onNavigateAbout, onNavigateHome, onNavigateLandSurveying, onNavigateSolarWind, onNavigateBuildingConstruction, onNavigateElectricWork, onNavigateBuildingManagement, onNavigateProjects, onNavigateSustainability, onNavigateCareers, onNavigateContact }: ServiceSuryeysProps) {
  return (
